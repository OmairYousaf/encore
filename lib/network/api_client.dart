...
import '../services/exception_handler/chi_exception_handler.dart';
import '../services/network/internet_connectivity.dart';
...
class ApiClient {
  ...
  static Future<ApiClient> create(String siteUrl, bool isCancled) async {
    _dispose();
    _connectivityListener();
    prefs = await SharedPreferences.getInstance();
    authToken = prefs!.getString('token') ?? '';
    // String baseUrl = 'https://$siteCode.$siteUrl';
    String baseUrl = 'https://encore.pointzbasketball.com/api';
    wBaseUrl = baseUrl;
    options = BaseOptions(
      baseUrl: baseUrl,
  ...
  static Future<APIResponse> login(Map<String, dynamic> request,
    ...
    return CHIExceptionHandler.exceptionWrapper(() async {
      ...
      if (resp.data['status'] == true) {
        ...
        return {"status": "Error", "ErrorMessage": resp.data['message']};
      }
    });
  }
